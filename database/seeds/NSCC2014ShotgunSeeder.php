...
class NSCC2014ShotgunSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        DB::transaction(function () {
            ...
            foreach ($participations as $participation) {
                ...
                $score['score'] = $participation->shotgunTotal;
                $score['final_score'] = $participation->shotgunFinalTotal;
            ...
            //SOME FUCKING REASON THIS DOESNT WORK ... THE - CREATES ISSUE
            $statement1 = 'update ' . $DBNAME . '.Participation set shooterID = right(shooterID,13)';
            DB::update($statement1);
            $statement1 = 'update ' . $DBNAME . '.shooterm set shooterID = right(shooterID,13)';
            DB::update($statement1);
